...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'expirationtime'               => 'وقت انتهاء صلاحيته',
        'ar_name'                      => 'اﻹسم بالعربية',
        'en_name'                      => 'اﻹسم باﻹنجليزية',
        'icon'                         => 'الايكونة',
        'menus'                        => 'القوائم',
        'span'                         => 'سبان',
        'ar_description'               =>'الوصف بالعربية',
        'en_description'               => 'الوصف باﻹنجليزية',
        'name.0'                       =>'اﻹسم بالعربية',
        'name.1'                       =>'اﻹسم باﻹنجليزية',
        'description.0'                =>'الوصف بالعربية',
        'description.1'                =>'الوصف باﻹنجليزية',
        'span.0'                       =>'الكلمة الهامشية بالعربية',
        'span.1'                       =>'الكلمة الهامشية بالانجليزية',
        'contract'                     =>'العقد',
        'firstname'                    =>'الاسم الاول',
        'lastname'                     =>'اسم العائلة',
        'name.ar'                      =>'اﻹسم بالعربية',
        'name.en'                      =>'اﻹسم باﻹنجليزية',
        'uniqueid'                     =>'رقم المركبة',
